...
export async function convertMarketItemStruct2MarketItem(
  item: MarketItemStructOutput
) {
...
export async function convertMarketItemStructs2MarketItems(
  items: MarketItemStructOutput[]
) {
